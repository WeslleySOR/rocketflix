  ...
  const getMoviesFromApi = async () => {
    ...
    await instance
      ...
      .then((response) => {
        ...
        if (width < 768) window.scrollTo(0, 260);
      });
  };
  return (
    <>
      <main className="min-h-screen w-full flex flex-col justify-center gap-8">
        ...
        {Object.keys(actualMovie).length !== 0 && (
          <div className="flex flex-col gap-9 w-full mb-8 md:mb-0 md:w-[42.25rem] md:mx-auto md:flex-row md:h-96 md:overflow-hidden">
